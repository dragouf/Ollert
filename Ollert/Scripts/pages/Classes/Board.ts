...
class Board {    
    id: number;
    lists: KnockoutObservableArray<List>;
    currentUser: KnockoutObservable<User>;
        
    displayArchive: KnockoutObservable<boolean>;
    dialogNewList: KnockoutObservable<List>;
    dialogCurrentList: KnockoutObservable<List>;
    dialogNewCard: KnockoutObservable<Card>;
    dialogCurrentCard: KnockoutObservable<Card>;    

    // Methods
    groupedListIndexes: () => Array<number>;
    showUsers: () => void;
    modalAddTable: () => void;
    addTable: () => void;
    deleteTable: (data: List) => boolean;
    addCard: () => void;
    openCardDetails: (data: List) => void;
    editCard: (data: Card) => void;
    movingCard: (arg: KnockoutSortableAfterMoveArguments) => void;
    loadData: (serverLists: Array<Ollert.ServerList>) => void;
    ...
    constructor(data: IBoard) {
        ...
        this.lists = ko.observableArray(new Array<List>());
        ...
        this.addTable= () => {
            // Sauvegarde la liste
            OllertApi.addList(this.dialogNewList(), function (listId) {
                // AJAX CALLBACK
        ...
        this.openCardDetails = (data: List) => {
            this.dialogCurrentList(data);
            $('#modal-ajout').modal('show');
        }
        this.editCard = (data: Card) => {
        ...
        // drag and drop api
        this.movingCard = (arg: KnockoutSortableAfterMoveArguments) => {
        ...
        // CHARGEMENT
        this.loadData = (serverLists: Array <Ollert.ServerList>) => {
            var initialTables = new Array<List>();
